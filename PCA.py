...
peptide_residues = range(1, 17) #1,17 and seganame PROA was used for PCA of receptor N-terminus. segname PROB and resid 1, 10 was used for GnRH PCA 
...
#################### comment for gpcr residues //// only uncoment for segname PROB selection (peptide) ####################
